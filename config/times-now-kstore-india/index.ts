...
export const TIME_NOW_CONFIG: Config = {
  currency: {
    k_cash: {
      ...
      logo: {
        stage:
          "https://pre-prod-admin-bucket.kgen.io/website-images/timesCash.png",
    ...
    times_point: {
      ...
      logo: {
        stage:
          "https://pre-prod-admin-bucket.kgen.io/website-images/timesCoin.png",
  ...
  kStoreLogo: {
    stage:
      "https://pre-prod-admin-bucket.kgen.io/website-images/timesKstoreLogo.png",
